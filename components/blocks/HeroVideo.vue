...
<template>
    ...
    <div class="relative flex items-center justify-center h-screen mb-12 overflow-hidden">
        <div
            class="relative z-30 p-5 text-2xl text-white justify-center"
            align="center"
        >
            <div class="text-white text-h2 font-weight-black align-center justify-center">
                <div v-html="props.data.headline"></div>
            </div>
            <div class='text-white text-h5 mt-5 pt-5 align-center font-weight-bold justify-center'>
                {{ props.data.content }}
            </div>
        ...
        <video
            ...
            loop
            :poster='bgimageurl'
            class="absolute z-10 w-auto min-w-full min-h-full max-w-none resize-none">
  ...
  <div
    class="relative z-30 p-5 text-2xl justify-center"
  >
        <div class="text-white text-h2 font-weight-black align-center justify-center">
            <div v-html="props.data.headline"></div>
        </div>
        <div class='text-white text-h5 mt-5 pt-5 font-weight-bold justify-center'>
            {{ props.data.content }}
        </div>
        <div class="py-10 mt-5 pt-5">
        ...
        <video  
            ...
            loop
            :poster='bgimageurl'
            class="absolute z-10 w-auto min-w-full max-w-full">
            <source :src='url' type='video/mp4'>
        </video>
    ...
    <div class="text-box-over py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <v-col align-self="center" >
                        <div 
                            ...
                            class="text-box-over d-flex flex-column 
                                ...
                                pt-10 mt-10">
                            <div class="text-h2 font-weight-black align-center justify-center">
                               <div v-html="props.data.headline"></div>
                            </div>
